...
| Phase 0 — Foundation | Done | Astro Workers scaffold ([PR #3](https://github.com/cjlawson02/photography/pull/3)) |
| Phase 1 — Ingest | In progress | Presign + complete + compress-once; Access/CORS blocked on hostname |
...
| Date | Update |
| --- | --- |
| 2026-09-25 | Phase 0 merged; Phase 1 ingest in progress (presign/complete/reprocess; provisional D1 tables) |
